...
export class  SolicitudesProvider {
  ...
  public detalleByFormulario(objeto: any) {
    return this.http.post(this.urlProvider.getDetalleFormulario(), JSON.stringify(objeto), {
      headers: new Headers({'Content-Type': 'application/json'})
    })
      .map((res: Response) => res);
  }
  ...
  public insertFormularioNuevo(objeto: any) {
    return this.http.post(this.urlProvider.insertNuevoFormulario(), JSON.stringify(objeto), {
      headers: new Headers({'Content-Type': 'application/json'})
    })
      .map((res: Response) => res);
  }

  public updateFormulario(objeto: any) {
    return this.http.post(this.urlProvider.updateFormulario(), JSON.stringify(objeto), {
      headers: new Headers({'Content-Type': 'application/json'})
    })
      .map((res: Response) => res);
  }
  ...
  public sendMail(objeto: any) {
    return this.http.post(this.urlProvider.sendMail(), JSON.stringify(objeto), {
      headers: new Headers({'Content-Type': 'application/json'})
    })
      .map((res: Response) => res);
  }

  public sendMailAprobador(objeto: any) {
    return this.http.post(this.urlProvider.sendMailAprobador(), JSON.stringify(objeto), {
      headers: new Headers({'Content-Type': 'application/json'})
    })
      .map((res: Response) => res);
  }
